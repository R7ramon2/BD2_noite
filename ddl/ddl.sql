...
VALUES
  (30001,"fulanada", "123456",1),
  (30002,"sophlav", "33333s", 2),
  (30003,"sebrita", "344432", 3),
  (30004,"emanu", "dfm222", 4),
  (30005,"carlosnasc", "1001010", 5),
  (30006,"jocamelo", "sadas", 6),
  (30007,"ivinho", "uuuunnnm", 7),
  (30008,"severinalopes", "12321", 8),
  (30009,"giugoes", "kdkdk2", 9),
  (30010,"fwand", "11123312", 10),
  (30011,"cbonacci", "12991", 11),
  (30012,"mmatos", "8888h", 12),
  (30013,"brborges", "kkkkal", 13),
  (30014,"claudinha", "111111", 14),
  (30015,"natjorge", "2222", 15),
  (30016,"ffome", "44444", 16),
  (30017,"bruninha", "123123", 17),
  (30018,"vitorsc", "çaçaça", 18),
  (30019,"juliafelix", "lauaj", 19),
  (30020,"samcham", "31923812", 20),
  (30021,"ericamarq", "asjkdjasd", 21),
  (30022,"taurush", "gçglf", 22),
  (30023,"clarkklenio", "dlflf", 23),
  (30024,"vivimaria", "594i34", 24),
  (30025,"forebs", "fffffpo023", 25),
  (30026,"mariam", "3434932", 26),
  (30027,"luizant", "1123123213", 27),
  (30028,"egroj", "1o1o12k", 28),
  (30029,"xuxuxaxa", "111222344322", 29),
  (30030,"matosdani", "101223", 30),
  (30031,"tavdanielly", "1232332", 31),
  (30032,"maurinha", "111111222", 32),
  (30033,"amiltttt", "wkwkw1", 33),
  (30034,"willwatt", "qoqoqo", 34),
  (30035,"tetetesoura", "10012", 35),
  (30036,"raamorim", "1232314", 36)
;
...
values
    ...
    ("Posto Bandeirantes", 3, 6, "10.583.052/0001-91", "3123-2134", "Av Jose Bonifacio, 148", "Irmaos Freire"), -- 3
